package md54ed5d3d82bc760df3f16570e3e2f7544;
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("GalaSoft.MvvmLight.Views.DialogService+OnDismissListener, GalaSoft.MvvmLight.Platform, Version=5.4.1.0, Culture=neutral, PublicKeyToken=null", DialogService_OnDismissListener.class, __md_methods);
	}
	...
	public DialogService_OnDismissListener ()
	{
		...
		if (getClass () == DialogService_OnDismissListener.class)
			mono.android.TypeManager.Activate ("GalaSoft.MvvmLight.Views.DialogService+OnDismissListener, GalaSoft.MvvmLight.Platform, Version=5.4.1.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
